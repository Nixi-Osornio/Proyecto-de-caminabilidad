document.addEventListener("DOMContentLoaded", function () {
    ...
    function estiloCaminabilidad(feature) {
        const valor = parseFloat(feature.properties.indice_accesible);
            ...
            var capaCaminabilidad = L.geoJSON(data, {
                ...
                onEachFeature: (feature, layer) => {
                    ...
                    layer.bindPopup(`
                        ...
                        Índice Accesible: ${props.indice_accesible}<br>
                        Transporte: ${props.transporte}<br>
                        Usos mixtos: ${props.usos_mixtos}<br>
                        Uso público: ${props.uso_publico}<br>
                    `);
                }
            }).addTo(map);
