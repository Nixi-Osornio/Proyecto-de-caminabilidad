document.addEventListener("DOMContentLoaded", function () {
    ...
    function estiloCaminabilidad(feature) {
        const valor = parseFloat(feature.properties.indice_practicom);
            ...
            var capaCaminabilidad = L.geoJSON(data, {
                ...
                onEachFeature: (feature, layer) => {
                    ...
                    layer.bindPopup(`
                        ...
                        Índice Práctico-Cómodo: ${props.indice_practicom}<br>
                        Dimensión: ${props.dimension}<br>
                        Sombra: ${props.sombra}
                    `);
                }
            }).addTo(map);
