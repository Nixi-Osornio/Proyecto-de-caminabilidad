document.addEventListener("DOMContentLoaded", function () {
    ...
    function estiloCaminabilidad(feature) {
        const valor = parseFloat(feature.properties.indice_transitable);
            ...
            var capaCaminabilidad = L.geoJSON(data, {
                ...
                onEachFeature: (feature, layer) => {
                    ...
                    layer.bindPopup(`
                        ...
                        Índice Transitable: ${props.indice_transitable}<br>
                        Obstrucciones: ${props.obstrucciones}<br>
                        Pendiente: ${props.pendiente}<br>
                        Anchura: ${props.anchura}<br>
